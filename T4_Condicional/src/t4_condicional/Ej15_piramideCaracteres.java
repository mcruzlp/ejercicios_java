...
public class Ej15_piramideCaracteres {
  ...
  public static void main(String[] args) {
    System.out.println("Introduce el caracter con el que quieres dibujar la " + "pirámide, ");
    System.out.print("una letra, un número o un símbolo como *, +, -, $, &," + "etc.): ");
    Scanner s = new Scanner(System.in);
    String caracter = s.nextLine();

    System.out.println("Introduce la dirección en la que quieres que apunte la " + "pirámide: ");
